...
export default function SignInClient({ callbackUrl = '/' }: SignInClientProps) {
  ...
  // Only render after we have search params to avoid SSR issues
  if (!searchParams) {
    return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">Joe's AI</h1>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <ul className="mt-3 space-y-2 text-xs text-gray-600">
            <li className="flex gap-2">
              ...
              <span>Sync chat history across devices</span>
            </li>
            <li className="flex gap-2">
              <span className="text-blue-600">✓</span>
              <span>Access your profile anywhere</span>
            </li>
            <li className="flex gap-2">
              <span className="text-blue-600">✓</span>
